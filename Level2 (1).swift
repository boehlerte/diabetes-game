...
class Level2: SKScene, SKPhysicsContactDelegate{
    ...
    override func didMove(to view: SKView) {
        ...
        tipLabel.position = CGPoint(x: frame.midX, y: frame.midY - 150)
                ...
                if(!duplicate){
                    ...
                    if(food.carb){
                        ...
                        if(carb_count>=bfastMinCarbs && carb_count<=bfastMaxCarbs && b_plate) {
                            ...
                            results.position = CGPoint(x: frame.midX, y: frame.midY - 200)
                            ...
                            let when = DispatchTime.now() + 4 // delay
    ...
    func showCollectedItems(){
        ...
        for items in collectedItems{
            ...
            itemCard.position = CGPoint(x: xfloatSpacing, y: (frame.midY + 150) - yfloatSpacing)
    ...
    func showFinalPlate(){
        ...
        for items in collectedItems{
            ...
            let xfloatSpacing = (CGFloat)(xspacing)
            let yfloatSpacing = (CGFloat)(yspacing)
            itemCard.position = CGPoint(x: xfloatSpacing, y: (frame.midY) - yfloatSpacing)
            itemCard.zPosition = 4.0
            itemCard.name = "hint"
            addChild(itemCard)
            xspacing += 200
    ...
    func showHintItem(){
        ...
        print(hintCard)
        hintCard.position = CGPoint(x: frame.midX, y: frame.midY - 275)
